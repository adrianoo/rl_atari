...
class Agent(object):
    def __init__(self, game_handler, qnetwork, replay_memory, saver, batch_size=32, start_epsilon=1, final_epsilon=0.05,
                 exploring_duration=1000000):
    ...
    def play(self, episodes, start_eps=None, final_eps=None, exploring_duration=None):
        ...
        for episode_number in xrange(1, episodes):
            ...
            while True:
                ...
                self.saver.save(sess, DATA_DIR + 'net', global_step=(game_handler.getFrameNumber() + start_frame))
                break